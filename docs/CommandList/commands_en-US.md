...
|target         |Selects the active user, leave empty arg for select the first joined user              |\<uid>                      |No               |target \<uid>                       |target 740623067        |
...
|give            |Adds items, weapons, characters      |\<item\|weapon\|char\|equip> \<id/all> \<amount/lvl>|Yes              |add \<item\|weapon\|char> \<id> \<amount/lvl>|add char chr_0007_ikut 80|
