...
WeaponExhibitBreakPopupCtrl.OnCreate = HL.Override(HL.Any) << function(self, arg)
    ...
    self.view.weaponUpgradeAttributeNode:InitWeaponUpgradeAttributeNode({ fromLv = weaponExhibitInfo.curLv, fromBreakthroughLv = fromBreakthroughLevel, toLv = weaponExhibitInfo.curLv, toBreakthroughLv = toBreakthroughLevel, weaponInstId = weaponInfo.weaponInstId, })
