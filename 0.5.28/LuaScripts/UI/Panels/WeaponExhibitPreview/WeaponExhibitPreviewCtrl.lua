...
WeaponExhibitPreviewCtrl._PreviewWeaponBreakthrough = HL.Method(HL.Table, HL.Number) << function(self, weaponExhibitInfo, breakthroughLv)
    ...
    self.m_requireItemCelLCache:Refresh(breakItemList.Count, function(cell, index)
        ...
        cell:InitItem({ id = itemInfo.id, count = itemInfo.count }, true)
    end)
    self.view.fromWeaponSkillNode:InitWeaponSkillNode(weaponExhibitInfo.weaponInst.instId, { tryGemInstId = 0, tryRefineLv = weaponExhibitInfo.weaponInst.refineLv, tryBreakthroughLv = fromBreakthroughLv, fromBreakthroughLv = fromBreakthroughLv, fromRefineLv = weaponExhibitInfo.weaponInst.refineLv, })
    self.view.toWeaponSkillNode:InitWeaponSkillNode(weaponExhibitInfo.weaponInst.instId, { tryGemInstId = 0, tryRefineLv = weaponExhibitInfo.weaponInst.refineLv, tryBreakthroughLv = toBreakthroughLv, fromBreakthroughLv = fromBreakthroughLv, fromRefineLv = weaponExhibitInfo.weaponInst.refineLv, })
