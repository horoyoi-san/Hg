...
MapMarkDetailAvailableMissionCtrl.OnCreate = HL.Override(HL.Any) << function(self, args)
    ...
    local commonArgs = { titleText = missionRuntimeAsset.missionName:GetText(), descText = missionRuntimeAsset.missionDescription:GetText(), markInstId = markInstId, bigBtnActive = true, }
