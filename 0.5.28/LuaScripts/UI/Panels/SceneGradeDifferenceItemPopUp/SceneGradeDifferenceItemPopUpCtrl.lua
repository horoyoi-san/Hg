...
SceneGradeDifferenceItemPopUpCtrl.OnCreate = HL.Override(HL.Any) << function(self, args)
    ...
    self.m_sceneGradeCellList:Refresh(#itemLists, function(sceneGradeCell, sceneGrade)
        ...
        sceneGradeCell.normalTitleText.text = UIConst.SCENE_GRADE_TEXT[sceneGrade]
        sceneGradeCell.nowTitleText.text = UIConst.SCENE_GRADE_TEXT[sceneGrade]
...
SceneGradeDifferenceItemPopUpCtrl._FillSceneGradeCellItem = HL.Method(HL.Any, HL.Any) << function(self, sceneGradeCell, displayList)
