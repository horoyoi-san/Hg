...
BoxGameCtrl.s_messages = HL.StaticField(HL.Table) << { [MessageConst.HIDE_BOX_GAME_PANEL] = 'HidePanel', }
BoxGameCtrl.OnCreate = HL.Override(HL.Any) << function(self, args)
    ...
    self.view.buttonCancel.onClick:AddListener(function()
        GameInstance.world.gameMechManager.boxGameBrain:PutDownCurrentBox()
    end)
end
