...
DebugModel._RegisterCommand = HL.Method(HL.String, HL.String, HL.String, HL.Function, HL.Table, HL.Table, HL.String, HL.String, HL.String) << function(self, category, name, alias, func, args, defaultValues, friendlyName, tip, params)
