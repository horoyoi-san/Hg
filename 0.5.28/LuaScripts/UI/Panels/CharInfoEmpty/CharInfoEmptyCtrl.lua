...
CharInfoEmptyCtrl.s_messages = HL.StaticField(HL.Table) << { [MessageConst.REFRESH_CHAR_CONTROLLER_HINT] = 'RefreshCharControllerHint', [MessageConst.REFRESH_CHAR_EMPTY_SORTING_ORDER] = 'RefreshSortingOrder', }
