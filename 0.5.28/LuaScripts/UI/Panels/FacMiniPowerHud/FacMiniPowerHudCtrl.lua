...
FacMiniPowerHudCtrl.s_messages = HL.StaticField(HL.Table) << { [MessageConst.ON_EXIT_FACTORY_MODE] = 'OnExitFactoryMode', [MessageConst.ON_EXIT_BUILDING_MODE] = 'OnExitBuildingMode', [MessageConst.ON_IN_FAC_MAIN_REGION_CHANGE] = 'OnInFacMainRegionChange', [MessageConst.ON_FAC_BUILDING_PREVIEW_POSITION_ROTATION_CHANGED] = 'OnFacBuildingPreviewPositionRotationChanged', [MessageConst.ON_FAC_CHAPTER_RESET] = 'OnFacChapterReset', }
...
FacMiniPowerHudCtrl.OnShow = HL.Override() << function(self)
    self.m_miniPowerContent.gameObject:SetActive(true)
end
