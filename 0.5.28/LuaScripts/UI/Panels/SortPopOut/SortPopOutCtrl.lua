...
SortPopOutCtrl.InitSortOption = HL.Method(HL.Table, HL.Function, HL.Opt(HL.Number, HL.Boolean)) << function(self, sortOptions, onSortConfirm, curIndex, curIsAscending)
...
SortPopOutCtrl.InitSelectOption = HL.Method(HL.Table, HL.Function, HL.Function) << function(self, selectOptions, onSelectToggle, onSelectConfirm)
