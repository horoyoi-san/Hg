...
WeaponExhibitUpgradePopupCtrl.OnCreate = HL.Override(HL.Any) << function(self, arg)
    ...
    self.view.weaponUpgradeAttributeNode:InitWeaponUpgradeAttributeNode({ fromLv = fromLevel, fromBreakthroughLv = basicInfo.curBreakthroughLv, toLv = toLevel, toBreakthroughLv = basicInfo.curBreakthroughLv, weaponInstId = weaponInfo.weaponInstId, })
