...
UpgradeWeaponInfo.InitBreakWeaponInfo = HL.Method(HL.Table) << function(self, arg)
    ...
    self.view.weaponAttributeNode:InitWeaponUpgradeAttributeNode({ fromLv = weaponExhibitInfo.curLv, toLv = weaponExhibitInfo.curLv, fromBreakthroughLv = weaponInst.breakthroughLv, toBreakthroughLv = weaponInst.breakthroughLv + 1, weaponInstId = weaponExhibitInfo.weaponInst.instId, })
    self.view.weaponSkillNode:InitWeaponSkillNode(weaponInstId, { tryBreakthroughLv = weaponInst.breakthroughLv + 1, tryRefineLv = weaponInst.refineLv, })
end
