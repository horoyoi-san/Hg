...
CharInfoWeaponList.InitCharInfoWeaponList = HL.Method(HL.Table, HL.Function, HL.Opt(HL.Userdata, HL.Boolean)) << function(self, charInfo, onClickCallback, weaponType, skipGraduallyShow)
    self:_FirstTimeInit()
...
CharInfoWeaponList._RefreshWeaponCell = HL.Method(HL.Userdata, HL.Number) << function(self, object, index)
    ...
    cell.itemBig:InitItem({ id = weaponTemplateId, instId = weaponInstId }, function()
