...
WikiSearchGroupTutorials.InitWikiSearchGroupTutorials = HL.Method(HL.Table, HL.Function, HL.Opt(HL.Boolean)) << function(self, wikiSearchResult, onItemClicked, isFirstClicked)
    self:_FirstTimeInit()
    self.m_tutorialCache:Refresh(#wikiSearchResult.categoryResult, function(cell, luaIndex)
