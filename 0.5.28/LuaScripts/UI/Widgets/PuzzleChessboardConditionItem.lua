...
PuzzleChessboardConditionItem.m_conditionData = HL.Field(HL.Table)
...
PuzzleChessboardConditionItem.InitPuzzleChessboardConditionItem = HL.Method(HL.Table, HL.Number, HL.Number, HL.Number, HL.Boolean, HL.Boolean) << function(self, eColor2ConditionsTbl, cellSize, spacing, gridNum, isRow, isRectangle)
    self:_FirstTimeInit()
