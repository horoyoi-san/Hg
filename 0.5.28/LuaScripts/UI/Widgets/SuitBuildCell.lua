...
SuitBuildCell.InitSuitBuildCell = HL.Method(HL.String) << function(self, equipTemplateId)
    ...
    self.m_suitCellCache:Refresh(equipList.Count, function(cell, luaIndex)
        ...
        cell.cellLight.imageIcon.sprite = self:LoadSprite(UIConst.UI_SPRITE_EQUIP, UIConst.CHAR_INFO_EQUIP_LIST_SPRITE_NAME_PREFIX .. LuaIndex(data.partType:ToInt()))
        cell.cellDim.imageIcon.sprite = self:LoadSprite(UIConst.UI_SPRITE_EQUIP, UIConst.CHAR_INFO_EQUIP_LIST_SPRITE_NAME_PREFIX .. LuaIndex(data.partType:ToInt()))
