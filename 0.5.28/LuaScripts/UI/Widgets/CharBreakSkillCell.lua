...
CharBreakSkillCell.InitCharBreakSkillCell = HL.Method(HL.Table) << function(self, data)
    ...
    elseif isTalent then
        ...
        cell.icon.sprite = self:LoadSprite(UIConst.UI_SPRITE_FAC_SKILL_ICON, facSkillData.icon)
        cell.iconShadow.sprite = self:LoadSprite(UIConst.UI_SPRITE_FAC_SKILL_ICON, facSkillData.icon)
