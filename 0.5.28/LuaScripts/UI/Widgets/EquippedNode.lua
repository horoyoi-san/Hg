...
EquippedNode._SetCharIcon = HL.Method(HL.Number) << function(self, charInstId)
    ...
    self.view.iconImg.sprite = self:LoadSprite(UIConst.UI_SPRITE_CHAR_HEAD, spriteName)
...
EquippedNode._SetWeaponIcon = HL.Method(HL.Number) << function(self, weaponInstId)
    ...
    self.view.iconImg.sprite = self:LoadSprite(UIConst.UI_SPRITE_ITEM, itemData.iconId)
