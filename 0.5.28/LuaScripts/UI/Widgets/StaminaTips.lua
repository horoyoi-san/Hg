...
StaminaTips._RefreshTickRecover = HL.Method() << function(self)
    ...
    self.view.nextRecoverTime.text = string.format(Language.LUA_STAMINA_NEXT_RECOVER_TIME, UIUtils.getLeftTimeToSecondFull(nextLeftTime))
    self.view.fullRecoverTime.text = string.format(Language.LUA_STAMINA_FULL_RECOVER_TIME, UIUtils.getLeftTimeToSecondFull(fullLeftTime))
