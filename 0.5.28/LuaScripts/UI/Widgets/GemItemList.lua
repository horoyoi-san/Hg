...
local LIST_CONFIG = { [GEnums.ItemType.WeaponGem] = { filterTagGroupFunc = "generateConfig_WEAPON_EXHIBIT_GEM", infoProcessFunc = "processWeaponGem", sortOption = UIConst.WEAPON_GEM_SORT_OPTION, getDepotFunc = "_GetWeaponGemDepot" }, }
...
GemItemList._RefreshItemCell = HL.Method(HL.Userdata, HL.Number) << function(self, object, index)
    ...
    itemCell.itemBig:InitItem({ id = itemInfo.itemCfg.id, instId = itemInfo.itemInst.instId, count = 1, }, true)
