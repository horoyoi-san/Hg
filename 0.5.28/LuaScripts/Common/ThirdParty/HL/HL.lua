...
local MT_OVERRIDE = 5
local MT_FINAL = 6
local HyperLuaBuiltinTypes = { ["boolean"] = true, ["number"] = true, ["int"] = true, ["pointer"] = true, ["string"] = true, ["table"] = true, ["userdata"] = true, ["function"] = true, ["thread"] = true, ["any"] = true, }
local HyperLuaInitValueTypes = { ["boolean"] = { ["boolean"] = true, }, ["number"] = { ["number"] = true, }, ["int"] = { ["number"] = true, }, ["pointer"] = { ["nil"] = true, ["pointer"] = true, }, ["string"] = { ["string"] = true, }, ["table"] = { ["nil"] = true, ["function"] = true, }, ["userdata"] = { ["nil"] = true, ["function"] = true, }, ["function"] = { ["nil"] = true, ["function"] = true, }, ["thread"] = { ["nil"] = true, ["function"] = true, }, }
local HyperLuaParamValueTypes = { ["boolean"] = { ["boolean"] = true, }, ["number"] = { ["number"] = true, }, ["int"] = { ["number"] = true, }, ["pointer"] = { ["nil"] = true, ["pointer"] = true, }, ["string"] = { ["string"] = true, }, ["table"] = { ["nil"] = true, ["table"] = true, }, ["userdata"] = { ["nil"] = true, ["userdata"] = true, }, ["function"] = { ["nil"] = true, ["function"] = true, }, ["thread"] = { ["nil"] = true, ["thread"] = true, }, }
...
do
    function HL.SetRuntimeObjectTrackEnabled(enabled)
        if enabled == nil then
            enabled = not RuntimeObjectTrack
        end
        ...
        elseif paramType ~= "any" then
            ...
            if expectedTypes then
                if not expectedTypes[gotType] then
                    if ith <= requireCnt or gotType ~= "nil" then
                        local types = {}
                        for k, _ in pairs(expectedTypes) do
                            types[#types + 1] = "'" .. k .. "'"
                        end
