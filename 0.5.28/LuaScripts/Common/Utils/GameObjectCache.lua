...
GameObjectCache = HL.Class('GameObjectCache', CommonCache.CommonCache)
GameObjectCache.GameObjectCache = HL.Constructor(HL.Any, HL.Any, HL.Opt(HL.Function, HL.Function, HL.Function)) << function(self, template, root, onCreate, onUse, onCache)
