...
LuaNodeCache = HL.Class('LuaNodeCache', CommonCache.CommonCache)
LuaNodeCache.LuaNodeCache = HL.Constructor(HL.Any, HL.Any, HL.Opt(HL.Function, HL.Function, HL.Function)) << function(self, template, uiRoot, onCreate, onUse, onCache)
