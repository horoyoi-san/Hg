...
PhaseCinematic.s_messages = HL.StaticField(HL.Table) << { [MessageConst.ON_PLAY_CUTSCENE] = { 'OnCinematicStart', false }, [MessageConst.ON_FINISH_CUTSCENE] = { 'OnCinematicEnd', true }, }
