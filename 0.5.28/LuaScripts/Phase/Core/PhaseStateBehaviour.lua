...
PhaseStateBehaviour.m_coroutines = HL.Field(HL.Table)
...
PhaseStateBehaviour._StartCoroutine = HL.Method(HL.Function) << function(self, func)
    local coroutine = CoroutineManager:StartCoroutine(func, self)
    self.m_coroutines[coroutine] = coroutine
end
PhaseStateBehaviour._ClearCoroutine = HL.Method(HL.Thread).Return(HL.Boolean) << function(self, coroutine)
    local res = CoroutineManager:ClearCoroutine(coroutine)
    self.m_coroutines[coroutine] = nil
    return res
end
