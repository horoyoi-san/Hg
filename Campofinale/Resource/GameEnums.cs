namespace Campofinale.Resource
{
    ...
    public enum InteractiveComponentType // TypeDefIndex: 715
    {
        TriggerObserver = 0,
        Animator = 1,
        ElectricNode = 2,
        ...
        TriggerZone = 62,
        AttackTrigger = 63,
        InteractiveCommonPerform = 64,
        LogicBaseComponent = 66,
        DoodadCommonComponent = 67,
        VerticalRopeComponent = 68,
        CommonTwoStateComponent = 69,
        DoodadInteractComponent = 71,
        EmptyLogicComponent = 72,
        CampfireComponent = 73,
        DoodadGradeComponent = 74,
        InteractiveSystemLayerComponent = 77,
        MainCharacterInterestComponent = 81,
        WaterVolumeTransferer = 82,
        WaterVolumeSwitch = 83,
        InteractiveTwoStateRecord = 84,
        InteractivePorpToGlobalVarSync = 85,
        WaterAbsorbedImpactComponent = 86,
        WaterProgressComponent = 87,
        CurveMoveComponent = 88,
        BambooRaftComponent = 89,
        CoolerUnitComponent = 90,
        SteamBlockerComponent = 91,
        TreasureComponent = 92,
        MultiStateCycleComponent = 93,
        NarrativeComponent = 94,
        AutoMovePlatformComponent = 95,
        ManualMovePlatformComponent = 96,
        FixableRobotComponent = 97,
        WaterSwitch = 98,
        HydrantComponent = 99,
        ErosionSludgeCore = 100,
        WaterPipeComponent = 101,
        CommonSwitchComponent = 102,
        PurificationDeviceComponent = 103,
        InfraredGroupComponent = 104,
        VendingMachineComponent = 105,
        TwoPointMovementComponent = 106,
        CustomCurveMoveComponent = 107,
        PressureSwitchComponent = 108,
        MovingPlatClientOnlyComponent = 109,
        InteractivePhysicsDestructible = 110,
        InteractiveDestructicle = 111,
        WeekRaidMineComponent = 112,
        WeekRaidMineCoreComponent = 113,
        FlammableBombComponent = 114,
        NavmeshDynamicBakeArea = 115,
        ScannableTrace = 116,
        SuperPressureBoardComponent = 117,
        LSMControlledSwitchComponent = 118,
        ScanTrigger = 119,
        BambooRaftDockComponent = 120,
        StainComponent = 121,
        StepOnTrigger = 122,
        HiddenMark = 123,
        WaterGunDriveBallComponent = 124,
        WaterProgressDriveCurveMovementComponent = 125,
        InteractiveWaterFloater = 126,
        InteractiveCollectionPiece = 127,
        InteractiveUnstablePlatform = 128,
        InteractiveHaveElectric = 129,
        ElectricFenceComponent = 130,
        CommonMultiStateComponent = 131,
        InteractiveHintPerformComponent = 132,
        InteractiveModelLevelUpComponent = 133,
        GameplayElectricityNode = 134,
        OnewaySwitchElectric = 135,
        SwitchCommonElectric = 136,
        TwoStateElectricAuto = 137,
        TwoStateElectricManual = 138,
        InteractiveDynamicAINavComponent = 139,
        HeightZeroMarker = 140,
        BombSpawner = 141,
        CollectionCoin = 142,
        UnrealWallComponent = 143,
        BalloonMan = 144,
        SmallButterfly = 145,
        LeaderButterfly = 146,
        WeekRaidTreasureComponent = 147,
        InteractiveSwitchAttackElectric = 148,
        DungeonExitComponent = 149,
        JumpMachineElectric = 150,
        DoorCommon = 151,
        SwitchElectricComponent = 152,
        InteractiveFacHintPerformComponent = 153,
        LifterComponent = 154,
        LifterForBoxGameComponent = 155,
        WeekRaidRuneComponent = 156,
        OutFall = 157,
        ContinuousInteractComponent = 158,
        SwitchAttackMultiStateComponent = 159,
        ShowGuideWithConditionComponent = 160,
        MatrixElementComponent = 161,
        RollingStoneComponent = 162,
        RuneColumnComponent = 163,
        RuneCheckpointComponent = 164,
        MatrixCenterComponent = 165,
        SpecialSightComponent = 166,
        GenderChangeSystemComponent = 500,
        KiteStationSystemComponent = 501,
        SnapshotSystemComponent = 502,
        DomainShopSystemComponent = 503,
        SpaceshipShowcaseSystemComponent = 504,
        SpaceshipCabinConsoleComponent = 505,
        FacRegionUpgradeSystemComponent = 506,
        RecycleBinSystemComponent = 507,
        SpaceshipRoomDoor = 508,
        DomainDepotSystemComponent = 509,
        SpaceshipCharacterWallComponent = 510,
        SpaceshipScreenComponent = 511,
        SpaceshipWeaponWallComponent = 512,
        SpaceshipRegionWallComponent = 513,
        DungeonEntryComponent = 514,
        WeekRaidEntryComponent = 515,
        SpaceshipCreditShopComponent = 516,
        SpaceshipMedalWallComponent = 517,
        WorldEnergyPointSystemComponent = 518,
        SpaceshipSummonComponent = 519,
        SpaceshipGuestTerminalComponent = 520,
        SpaceshipVisitPortalComponent = 521,
        FactoryBuildingBaseComponent = 1000,
        FactorySocialBuildingComponent = 1001,
        ActivitySnapshotComponent = 2000
    }
...
public enum EntityDataType // TypeDefIndex: 24999
    ...
    public enum BitsetType
    {
        ...
        InteractiveTwoState = 52,
        UnreadUnlockSpaceshipRoomType = 53,
        UnlockSpaceshipRoomType = 54,
        UnlockUserAvatar = 55,
        UnlockUserAvatarFrame = 56,
        UnlockBusinessCardTopic = 57,
        SpecialGameEvent = 58,
        RadioID = 59,
        GotWeapon = 60,
        ReadNewVersionEquipTechFormula = 61,
        MistMapUnlocked = 62,
        ReadAchive = 63,
        CameraVolume = 64,
        ReadFacTechTreeUnhiddenTech = 65,
        ReadFacTechTreeUnhiddenCategory = 66,
        MistMapMVWatched = 67,
        RemoteCommunicationWaitForPlay = 68,
        MissionCompletedOnce = 69,
        PSNCupUnlocked = 70,
        UnreadWeekRaidMission = 71,
        UnlockGameEntranceActivitySeries = 72,
        UnlockDomainDepot = 73,
        UnlockRecycleBin = 74,
        ManualCraftedItem = 75,
        UnReadNewActivityNotify = 76,
        ReadPictureIds = 77,
        ReadShopId = 78,
        ReadShopGoodsId = 79,
        ReadBPSeasonId = 80,
        ReadBPTaskId = 81,
        ReadCashShopGoodsId = 82,
        NewAvatarUnlock = 83,
        NewAvatarFrameUnlock = 84,
        NewThemeUnlock = 85,
        ReadCharPotentialPicIds = 86,
        EnumMax = 87
    }
